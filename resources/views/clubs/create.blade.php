    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <form action="{{route('clubs.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="place" class="">Количество мест</label>
                    <input type="text" id="place" class="form-control" name="place">
                </div>

                <div class="form-group">
                    <label for="priority" class="">Картинка</label>
                    <input type="file" name="image" class="form-control">
                </div>

                <div class="form-group">
                    <label for="priority" class="">Приоритеты</label>
                    <textarea name="priority" id="text" cols="30" rows="10" class="form-control"></textarea>
                </div>
...
{{--
                ...
                <div class="form-group">
                    ...
                    <input id="priority" type="hidden" name="priority">
